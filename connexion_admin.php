...
<html lang="fr">
	<head>
		...
		<title>Chronoshirt - Admin Connexion</title>
...
<body class="inscription">
	...
	<h1 class="h1 center">Hello, Welcome on your Backoffice ! Please sign in to continue !</h1>

	<form method="post" action="recup_connexion_admin.php">
